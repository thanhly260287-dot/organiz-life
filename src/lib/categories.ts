...
export const DEFAULT_CATEGORIES: Omit<Category, "tasks" | "subcategories" | "vision">[] = [
  ...
  { id: "desires", name: "Ce que je désire dans ma vie", icon: "Heart", color: BRAND_VIOLET, priority: 28 },
  { id: "rejections", name: "Ce que je ne veux plus dans ma vie", icon: "Ban", color: BRAND_BLUE, priority: 29 },
  { id: "accept", name: "Ce que je veux bien accepter", icon: "CheckCircle2", color: BRAND_VIOLET, priority: 30 },
  { id: "no-accept", name: "Ce que je n'accepterai plus jamais", icon: "ShieldOff", color: BRAND_BLUE, priority: 31 },
];
