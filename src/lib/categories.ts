...
export const DEFAULT_CATEGORIES: Omit<Category, "tasks" | "subcategories" | "vision">[] = [
  ...
  { id: "health", name: "Santé", icon: "HeartPulse", color: BRAND_BLUE, priority: 9 },
  { id: "sport", name: "Sport", icon: "Dumbbell", color: BRAND_VIOLET, priority: 10 },
  { id: "physique", name: "Physique", icon: "PersonStanding", color: BRAND_BLUE, priority: 11 },
