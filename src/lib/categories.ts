...
export const DEFAULT_CATEGORIES: Omit<Category, "tasks" | "subcategories" | "vision">[] = [
  ...
  { id: "ideas", name: "Idées", icon: "Lightbulb", color: BRAND_VIOLET, priority: 6 },
  { id: "health", name: "Santé", icon: "HeartPulse", color: BRAND_BLUE, priority: 7 },
  { id: "sport", name: "Sport", icon: "Dumbbell", color: BRAND_VIOLET, priority: 8 },
  { id: "physique", name: "Physique", icon: "PersonStanding", color: BRAND_BLUE, priority: 9 },
  { id: "savings", name: "Économies", icon: "PiggyBank", color: BRAND_VIOLET, priority: 10 },
  { id: "invest", name: "Placement", icon: "TrendingUp", color: BRAND_BLUE, priority: 11 },
  { id: "income", name: "Revenus", icon: "Wallet", color: BRAND_VIOLET, priority: 12 },
  { id: "income-res", name: "Ressources revenu", icon: "Coins", color: BRAND_BLUE, priority: 13 },
  { id: "income-sol", name: "Solutions revenu", icon: "Rocket", color: BRAND_VIOLET, priority: 14 },
  { id: "problems", name: "Problèmes", icon: "AlertCircle", color: BRAND_BLUE, priority: 15 },
  { id: "problems-res", name: "Ressources problèmes", icon: "BookOpen", color: BRAND_VIOLET, priority: 16 },
  { id: "problems-sol", name: "Solutions problèmes", icon: "Wrench", color: BRAND_BLUE, priority: 17 },
  { id: "goals", name: "Objectifs", icon: "Target", color: BRAND_VIOLET, priority: 18 },
  { id: "needs", name: "Besoins", icon: "ShoppingBag", color: BRAND_BLUE, priority: 19 },
